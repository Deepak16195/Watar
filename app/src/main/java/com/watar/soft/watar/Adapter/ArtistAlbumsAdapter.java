...
public class ArtistAlbumsAdapter extends RecyclerView.Adapter<ArtistAlbumsAdapter.ProductViewHolder> {
    List<ArtsitDetails.AlbumsEntity> mAlbums=new ArrayList<>();
    int mPosition;

    Context context;
    String Menu;
//, int aPosition
    public ArtistAlbumsAdapter(Context mContext, List<ArtsitDetails.AlbumsEntity> aAlbum) {
        this.mAlbums = aAlbum;
        ...
        public ProductViewHolder(View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ArtsitDetails.AlbumsEntity albumsEntity = mAlbums.get(getAdapterPosition());
